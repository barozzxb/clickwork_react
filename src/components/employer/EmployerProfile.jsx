...
const EmployerProfile = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const token = localStorage.getItem('token');
            const response = await axios.put(`${API_PREFIX}/employer/profile`, formData, {
                headers: { 'Authorization': `Bearer ${token}` }
            });
    ...
    return (
        <>
            <EmployerNavbar />
            <div className="container" style={{ marginTop: '80px', padding: '20px' }}>
                <h2 className="mb-4">Hồ sơ doanh nghiệp</h2>
                                                ...
                                                <div className="col-md-8">
                                                    <div className="row mb-3">
                                                        <div className="col-md-6">
                                                            ...
                                                            <p><strong>Số điện thoại:</strong> {profile.phonenum}</p>
                                                            <p><strong>Website:</strong> {profile.website}</p>
                                                            <p><strong>Mã số thuế:</strong> {profile.taxnumber}</p>
                                                        </div>
                                                        <div className="col-md-6">
                                                            <p><strong>Ngày làm việc:</strong> {profile.workingdays}</p>
                                                            <p><strong>Quy mô công ty:</strong> {profile.companysize}</p>
                                                            <p><strong>Mạng xã hội:</strong> {profile.sociallink}</p>
                                                        </div>
                                                    </div>
                        ...
                        <div className="card mb-4">
                            ...
                            <div className="card-body">
                                <div className="d-grid">
                                    <Link to="/employer/profile/password" className="btn btn-outline-primary mb-3">
                                        Đổi mật khẩu
                                    </Link>
                                    <Link to="/employer/profile/addresses" className="btn btn-outline-primary">
