...
const SupportRequest = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:9000/api/support/request', {
                method: 'POST',
                headers: {
        ...
        <div className="container mt-5">
            <div className="card">
                <div className="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <h4 className="mb-0">Yêu cầu hỗ trợ</h4>
                    <button
                ...
                <div className="card-body">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-3">
                            <label htmlFor="title" className="form-label">Tiêu đề yêu cầu</label>
                            <input
                                type="text"
